CREATE TABLE "provider_transaction_attempts" (
	...
	CONSTRAINT "provider_transaction_attempts_identity_check" CHECK (("provider_transaction_attempts"."status" = 'created' and "provider_transaction_attempts"."txid" is null and "provider_transaction_attempts"."expiration_at" is null) or ("provider_transaction_attempts"."status" <> 'created' and "provider_transaction_attempts"."txid" is not null and "provider_transaction_attempts"."expiration_at" is not null))
);
